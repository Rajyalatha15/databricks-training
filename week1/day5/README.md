...
📝 Overview
Day 5 continued window functions and introduced CTEs (Common Table Expressions). Practiced on db-fiddle.com using a retail sales dataset.
...
File	Description
practice_queries.txt	Practice questions on advanced window functions and CTEs
solution_queries.sql	SQL solutions for CTE and window function exercises
README.md	Summary of Day 5 learnings
